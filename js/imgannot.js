...
var Mia = {
	...
	prep_osd: function (tile, type){
		...
		if(!(document.querySelector("head meta[property]")) && Object.keys(this.cinfo).length)
...
var Mpj = {
	...
	proc_annot: function (def){
		...
		var res = {"type": null, "tile": tile, "anno": {}, "info": info};
...
Canvas.prototype = {
	proc: function(tiles, cv, info){
		...
		if(this.is_subcanvas){
			...
			else if(cv.thumbnail) set_thumb(this, cv.thumbnail);
